...
exports.addDeclaration = exports.addArrayElement = exports.addObjectProperty = exports.findDeclarationByIdentifier = exports.isNodeExported = exports.hasDecoratorCall = exports.getClassWithDecorator = void 0;
...
function getClassWithDecorator(tree, path, decoratorName) {
    return (0, schematics_1.findNodes)((0, schematics_1.parseSourceFile)(tree, path), ts.SyntaxKind.ClassDeclaration)
...
function findDeclarationByIdentifier(source, identifierText) {
    return (0, schematics_1.getSourceNodes)(source)
...
function addNodeArrayElement(tree, source, node, element) {
    ...
    const nodeIndentation = ' '.repeat((0, formatting_1.getNodeIndentation)(source.getFullText(), node));
...
function addDeclaration(tree, modulePath, componentClass, importPath) {
    const source = (0, schematics_1.parseSourceFile)(tree, modulePath);
    const declarationsChanges = (0, schematics_1.addDeclarationToModule)(source, modulePath, componentClass, importPath);
    (0, change_1.applyInsertChange)(tree, (0, core_1.normalize)(source.fileName), ...declarationsChanges);
}
