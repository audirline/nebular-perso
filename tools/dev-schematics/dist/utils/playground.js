...
exports.isInPlaygroundRoot = exports.findRoutingModule = exports.findFeatureModule = exports.hasComponentsInDir = exports.hasRoutingModuleInDir = exports.hasFeatureModuleInDir = exports.getRoutingModuleFromDir = exports.getFeatureModuleFromDir = exports.getDirectivesFromDir = exports.getComponentsFromDir = exports.getServicesFromDir = exports.isRoutingModule = exports.isFeatureModule = exports.isComponent = exports.isDirective = exports.isService = exports.isLayoutPath = exports.generateRoutingModuleClassName = exports.generateFeatureModuleClassName = exports.generateRoutingModuleFileName = exports.generateFeatureModuleFileName = exports.isBasePlaygroundModule = exports.isRootPlaygroundModule = exports.getModuleDirs = exports.getPlaygroundDirs = exports.getPlaygroundRootDir = exports.INCLUDE_DIRS = exports.NO_LAYOUT_COMPONENT_CLASS = exports.NO_LAYOUT_MODULE_CLASS = exports.NO_LAYOUT_ROUTING_MODULE_PATH = exports.NO_LAYOUT_MODULE_PATH = exports.NO_LAYOUT_DIR_PATH = exports.NO_LAYOUT_DIR_NAME = exports.LAYOUT_COMPONENT_CLASS = exports.LAYOUT_MODULE_CLASS = exports.LAYOUT_ROUTING_MODULE_PATH = exports.LAYOUT_MODULE_PATH = exports.LAYOUT_DIR_PATH = exports.LAYOUT_DIR_NAME = exports.PLAYGROUND_ROUTING_MODULE_PATH = exports.PLAYGROUND_PATH = exports.ROUTING_MODULE_EXT = exports.FEATURE_MODULE_EXT = exports.PREFIX = void 0;
const core_1 = require("@angular-devkit/core");
exports.PREFIX = '';
exports.FEATURE_MODULE_EXT = '.module.ts';
exports.ROUTING_MODULE_EXT = '-routing.module.ts';
exports.PLAYGROUND_PATH = (0, core_1.normalize)('/src/playground/');
exports.PLAYGROUND_ROUTING_MODULE_PATH = (0, core_1.join)(exports.PLAYGROUND_PATH, `playground${exports.ROUTING_MODULE_EXT}`);
exports.LAYOUT_DIR_NAME = 'with-layout';
exports.LAYOUT_DIR_PATH = (0, core_1.join)(exports.PLAYGROUND_PATH, exports.LAYOUT_DIR_NAME);
exports.LAYOUT_MODULE_PATH = (0, core_1.join)(exports.LAYOUT_DIR_PATH, `${exports.LAYOUT_DIR_NAME}${exports.FEATURE_MODULE_EXT}`);
exports.LAYOUT_ROUTING_MODULE_PATH = (0, core_1.join)(exports.LAYOUT_DIR_PATH, `${exports.LAYOUT_DIR_NAME}${exports.ROUTING_MODULE_EXT}`);
...
exports.NO_LAYOUT_DIR_PATH = (0, core_1.join)(exports.PLAYGROUND_PATH, exports.NO_LAYOUT_DIR_NAME);
exports.NO_LAYOUT_MODULE_PATH = (0, core_1.join)(exports.NO_LAYOUT_DIR_PATH, `${exports.NO_LAYOUT_DIR_NAME}${exports.FEATURE_MODULE_EXT}`);
exports.NO_LAYOUT_ROUTING_MODULE_PATH = (0, core_1.join)(exports.NO_LAYOUT_DIR_PATH, `${exports.NO_LAYOUT_DIR_NAME}${exports.ROUTING_MODULE_EXT}`);
...
function getPlaygroundDirs(tree) {
    ...
    return pgDir.subdirs
        .filter((dirName) => exports.INCLUDE_DIRS.includes((0, core_1.join)(pgDir.path, dirName)))
...
function generateFeatureModuleFileName(moduleName) {
    return (0, core_1.fragment)(core_1.strings.dasherize(moduleName) + exports.FEATURE_MODULE_EXT);
}
...
function generateRoutingModuleFileName(moduleName) {
    return (0, core_1.fragment)(core_1.strings.dasherize(moduleName) + exports.ROUTING_MODULE_EXT);
}
...
function getServicesFromDir(dir) {
    return dir.subfiles.filter(isService).map((fileName) => (0, core_1.join)(dir.path, fileName));
}
exports.getServicesFromDir = getServicesFromDir;
function getComponentsFromDir(dir) {
    return dir.subfiles.filter(isComponent).map((fileName) => (0, core_1.join)(dir.path, fileName));
}
exports.getComponentsFromDir = getComponentsFromDir;
function getDirectivesFromDir(dir) {
    return dir.subfiles.filter(isDirective).map((fileName) => (0, core_1.join)(dir.path, fileName));
}
...
function getFeatureModuleFromDir(dir) {
    ...
    return moduleFileName ? (0, core_1.join)(dir.path, moduleFileName) : null;
}
...
function findFeatureModule(tree, path) {
    ...
    return moduleFile ? (0, core_1.join)(path, moduleFile) : findFeatureModule(tree, (0, core_1.dirname)(path));
}
...
function findRoutingModule(tree, path) {
    ...
    return moduleFile ? (0, core_1.join)(path, moduleFile) : findRoutingModule(tree, (0, core_1.dirname)(path));
}
exports.findRoutingModule = findRoutingModule;
function isInPlaygroundRoot(filePath) {
    return (0, core_1.dirname)(filePath) === exports.PLAYGROUND_PATH;
}
